...
<div class="container">
    ...
    <form action="{{ route('thetichdiem.update', $thetichdiem) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="mb-3">
            <label for="mathetichdiem" class="form-label">Mã Thẻ Tích Điểm</label>
            <input type="text" class="form-control" id="mathetichdiem" name="mathetichdiem" value="{{ old('mathetichdiem' , $thetichdiem->mathetichdiem) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="idkhachhang" name="idkhachhang" required>
                ...
                @foreach($khachhangs as $khachhang)
                    <option value="{{ $khachhang->makhachhang }}" {{ old('idkhachhang' , $thetichdiem->idkhachhang) == $khachhang->makhachhang ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="diemtichluy" name="diemtichluy" value="{{ old('diemtichluy' , $thetichdiem ->diemtichluy) }}" required>
        </div>
