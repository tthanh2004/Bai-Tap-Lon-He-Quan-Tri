    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            DB::table('hoadon')->insert([
                ...
                'idkhachhang' => strtoupper(Str::random(6)), // Mã khách hàng ngẫu nhiên, phải tồn tại trong bảng khachhang
                'idnhanvien' => strtoupper(Str::random(6)), // Mã nhân viên ngẫu nhiên, phải tồn tại trong bảng nhanvien
